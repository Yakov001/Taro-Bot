...
SYSTEM_PROMPT = (
    ...
    "Не используй «вы». Не говори, что ты ИИ. Добавляй эмодзи. Ответ — 4-6 предложений."
)
...
PAIR_SYSTEM_PROMPT = (
    ...
    "Добавляй эмодзи. Ответ — ровно 4-6 предложения."
)
...
def _sanitize(text: str) -> str:
    ...
    # Категории символов для удаления
    ...
    for ch in text:
        ...
        if cat in banned_categories:
            continue
        # Удаляем control characters, кроме табуляции и переноса строки
